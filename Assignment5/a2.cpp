...
int main()
{
    ...
    headPtr->link->link = new Node;
     ...
     headPtr->link->link->data  = 1;

     headPtr->link->link->link = new Node;
     headPtr->link->link->link->link = 0;
     headPtr->link->link->link->data  = 3;

     headPtr->link->link->link->link = new Node;
     headPtr->link->link->link->link->link = 0;
     headPtr->link->link->link->link->data  = 4;
/*
     headPtr->link->link->link->link->link = new Node;
     headPtr->link->link->link->link->link->link = 0;
     headPtr->link->link->link->link->link->data  = 3;

     headPtr->link->link->link->link->link->link = new Node;
     headPtr->link->link->link->link->link->link->link = 0;
     headPtr->link->link->link->link->link->link->data  = 3;

     headPtr->link->link->link->link->link->link->link = new Node;
     headPtr->link->link->link->link->link->link->link->link = 0;
     headPtr->link->link->link->link->link->link->link->data = 8;

     headPtr->link->link->link->link->link->link->link->link = new Node;
     headPtr->link->link->link->link->link->link->link->link->link = 0;
     headPtr->link->link->link->link->link->link->link->link->data = 8;

     headPtr->link->link->link->link->link->link->link->link->link = new Node;
     headPtr->link->link->link->link->link->link->link->link->link->link = 0;
     headPtr->link->link->link->link->link->link->link->link->link->data = 8;

     headPtr->link->link->link->link->link->link->link->link->link->link = new Node;
     headPtr->link->link->link->link->link->link->link->link->link->link->link = 0;
     headPtr->link->link->link->link->link->link->link->link->link->link->data = 8;
*/


    cout << endl;

    cout << "List started as: 0 1 1 3 4 5 8" << endl;
...
void Form2NoDupListsUsgGivenList(struct Node* &headPtr1, struct Node* &headPtr2)
{
    ...
    while(backupHead1->link != 0)
    {
    	...
    	while(cur != 0)
    	{
    		cout << "backupHead1 is " << backupHead1->data << " cur is " << cur->data << endl;
    		if(backupHead1->data == cur->data)
    		{
    			...
    			else if(headPtr2 != 0 && matches == 1 && flag)
    			{
    	...
    	if(!repetition )
    	{
    		...
    		if(backupHead1->link->link == 0 && !repetition)
    		{
    			backupHead2 = new Node;
