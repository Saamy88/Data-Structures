...
void Form2NoDupListsUsgGivenList(Node* &headPtr1, Node* &headPtr2)
{    
	//empty list case
    if(headPtr1 == 0)
    {
    ...
    Node* backupHead1 = headPtr1,
        ...
        * pre = 0,
        * cur = 0;
    bool repetition = false, link;
    int matches = 0;

    while(backupHead1->link != 0)
    {
    	if(backupHead1->link != 0)
        ...
        while(cur != 0)
        {
        	cout << "backuphead is " << backupHead1->data << " cur data is " << cur->data << endl;
            ...
            if(backupHead1->data == cur->data)
            {
                ...
                else if(headPtr2 != 0 && matches == 1 && !link)
                {
                    Node * last = headPtr2;
        ...
        if(!repetition && !link)
        {
            ...
            cout << "creating " << backupHead1->data << endl;
...
// definition of Form2NoDupListsUsgGivenList
