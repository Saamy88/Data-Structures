...
namespace seqOfT  = cs3358fa14Assign04_sequenceOfT;
...
template <class T>
void show_list(seqOfT::sequence<T> src);
// Pre: (none)
// Post: The items of src are printed to cout (one per line).
//void show_list(seqOfT::sequence src);
// Pre: (none)
// Post: The items of src are printed to cout (one per line).
int get_object_num();
// Pre:  (none)
...
{
   seqOfT::sequence<double> s1;  // A sequence of double for testing
   seqOfT::sequence<char> s2; // A sequence of char for testing
